;;; inconfidente-theme.el --- Inconfidente Emacs
;;; Version: 1.0
;;; Code:

(deftheme inconfidente-theme "DOCSTRING for inconfidente-theme")
  (custom-theme-set-faces 'inconfidente-theme
...
(provide-theme 'inconfidente-theme)
